      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav align-items-center justify-content-end flex-grow-1 pe-3">
            ...
            {if not \core\RoleUtils::inRole("adm")}

              <li class="nav-item">
                <a class="nav-link px-3" aria-current="page" href="{$conf->action_url}home">Strona główna</a>
              </li>

            {else if isset($login)}

              <li class="nav-item">
                <a class="nav-link px-3" href="{$conf->action_url}users">Użytkownicy</a>
              </li>
            ...
            {if not isset($login)}
              ...
              <li class="nav-item">
                <a class="btn btn-primary px-3" href="{$conf->action_url}logowanie">Zaloguj sie</a>
              </li>
            ...
            {if isset($login)}
              ...
              <li class="nav-item px-3">
                <div> Zalogowano jako <span class="fw-bold">{$login}</span> </div>
              </li>
              <li class="nav-item">
                <a class="btn btn-primary px-3" href="{$conf->action_url}logout">Wyloguj się</a>
              </li>
        ...
        <div class="col-md-6 d-flex align-items-center justify-content-end">
          <ul class="footer-nav list-unstyled">
            <li class="nav-item me-2">
                <a class="nav-link pe-3 text-white " href="{$conf->action_url}home">Strona główna</a>
            </li>
        </ul>
        </div>
      </footer>
