...
<body data-bs-spy="scroll" data-bs-target="#header-nav" tabindex="0"><svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
 ...
 <symbol id="comment" viewBox="0 0 256 256"><path fill="currentColor" d="M128 24a104 104 0 0 0-91.82 152.88l-11.35 34.05a16 16 0 0 0 20.24 20.24l34.05-11.35A104 104 0 1 0 128 24m0 192a87.87 87.87 0 0 1-44.06-11.81a8 8 0 0 0-6.54-.67L40 216l12.47-37.4a8 8 0 0 0-.66-6.54A88 88 0 1 1 128 216"></path></symbol>
  ...
  <nav class="navbar navbar-expand-lg navbar-light container-fluid py-3 position-fixed">
    <div class="container">
      <a class="navbar-brand" href="index.html"><h3 class="logo" id="logo">AutoRent</h3></a>
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav align-items-center justify-content-end flex-grow-1 pe-3">
            <li class="nav-item">
              <a class="nav-link active px-3" aria-current="page" href="{$conf->action_url}home">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link px-3" href="{$conf->action_url}kontakt">Kontakt</a>
            </li>
			      
            
            <li class="nav-item dropdown text-center">
              <a class="nav-link px-3 dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Samochody
                <iconify-icon icon="material-symbols:arrow-drop-down"></iconify-icon></a>
              <ul class="dropdown-menu">
                <li>
                  <a href="about.html" class="dropdown-item text-uppercase">Hyundai <span class="badge bg-secondary"></span></a>
                </li>
                <li>
                  <a href="blog.html" class="dropdown-item text-uppercase">Jeep <span class="badge bg-secondary"></span></a>
                </li>
                <li>
                  <a href="single-post.html" class="dropdown-item text-uppercase">BMW
                    <span class="badge bg-secondary"></span></a>
                </li>
                <li>
                  <a href="cars.html" class="dropdown-item text-uppercase">Benz <span class="badge bg-secondary"></span></a>
                </li>
                <li>
                  <a href="car-single.html" class="dropdown-item text-uppercase">Ford <span class="badge bg-secondary"></span></a>
                </li>
              </ul>
            </li>
            {if not \core\RoleUtils::inRole("user") && not \core\RoleUtils::inRole("adm")}
             <li class="nav-item">
              <a class="nav-link px-3" href="{$conf->action_url}logowanie">Zaloguj sie</a>
            </li>
            {/if}
            {if \core\RoleUtils::inRole("user") ||  \core\RoleUtils::inRole("adm")}
             <li class="nav-item">
              <div> Zalogowano jako {$login} </div>
              
            </li>
            <li class="nav-item">
              
              <a class="nav-link px-3" href="{$conf->action_url}logout">Wyloguj sie</a>
            </li>
            {/if}
  ...
  <section id="process" class="padding-small" style="padding: 50px;">
        ...
        <div class="col-md-6 d-flex align-items-center justify-content-end">
          <ul class="footer-nav list-unstyled">
            <li class="nav-item me-2">
                <a class="nav-link pe-3 text-white " href="{$conf->action_url}home">Home</a>
            </li>
            <li class="nav-item me-2 mb-3">
                <a class="nav-link pe-3 text-white " href="{$conf->action_url}kontakt">Kontakt</a>
            </li>
            <li class="nav-item me-2 mb-3">
                <a class="nav-link pe-3 text-white " href="{$conf->action_url}logowanie">Logowanie</a>               
            </li>
            <li class="nav-item me-2 mb-3">
                <a class="nav-link pe-3 text-white " href="#">Samochody</a>
            </li>
        </ul>
        </div>
      </footer>
  ...
  <!-- script ================================================== -->
  <script src="http://localhost/home/public/assets/js/jquery-1.11.0.min.js"></script>
  <script src="http://localhost/home/public/assets/js/plugins.js"></script>
  <script src="http://localhost/home/public/assets/js/script.js"></script>
